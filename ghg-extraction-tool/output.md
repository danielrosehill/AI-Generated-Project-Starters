Here's the complete Streamlit application code based on the provided requirements. This code should be saved as a single Python file (e.g., `sustainability_parser.py`):
...
To run this application, you'll need to install the required dependencies. Create a `requirements.txt` file with the following:
...
```bash
streamlit run sustainability_parser.py
```

This implementation includes:
1. Support for PDF and DOCX file uploads
2. Text extraction and parsing for emissions data
3. Calculation of total and monetized emissions
4. CSV data export functionality
5. Clear data functionality
6. Error handling and user feedback
7. Detailed UI with instructions and disclaimers

The app uses regular expressions to extract emissions data, which could be enhanced with more sophisticated NLP techniques for better accuracy. The current implementation is a basic version that demonstrates the core functionality.